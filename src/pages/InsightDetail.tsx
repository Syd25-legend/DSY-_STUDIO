...
const InsightDetail = () => {
    ...
    const fetchInsightAndComments = async () => {
      ...
      if (insightError) {
        ...
        if (insightData) {
          await supabase
            .from("insights")
            .update({ views: insightData.views + 1 })
            .eq("id", id);
        }
      }
      setLoading(false);
  ...
  const handleCommentSubmit = async () => {
    ...
    const isCustomProfane = blockedPhrases.some((phrase) =>
      commentTextLower.includes(phrase),
    );
    ...
    <div className="min-h-screen bg-gradient-hero">
      {insight && (
        <SEO
          ...
          image={insight.media_url || undefined}
          ...
          <Card className="gaming-card">
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                <span>
                  <MessageCircle className="mr-2 h-5 w-5 inline-block" />
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex justify-end gap-2">
                        ...
                        <Button
                          ...
                          disabled={isSubmitting || !blockedPhrases.length}
                        >
