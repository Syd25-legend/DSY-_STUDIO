      ...
      <div className="container mx-auto px-4 pt-32 pb-16">
        ...
        >
          ...
          <p className="text-xl text-foreground max-w-3xl mx-auto">
            <span className="font-bold text-foreground">DSY Studio</span> is a
            company of creative souls who met through a combined love for video
            games and years of friendship. We feel that games are sometimes
            underappreciated as far an expressive storytelling medium and an art
            form aside from entertainement. Our objective is to manufacture
            playful, cerebral, and memorable gaming experiences that will
            engage, question, and put players in a position of feeling.
          </p>
        </motion.div>
                  ...
                  <Card className="gaming-card text-center h-full flex flex-col">
                    ...
                    <CardContent className="flex-grow flex flex-col justify-between">
                      ...
                      <a
                        ...
                        className="inline-flex items-center justify-center space-x-2 text-muted-foreground hover:text-[#C13584] transition-colors mt-auto"
                      >
