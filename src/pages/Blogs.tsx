...
const Blogs = () => {
  ...
  const BlogCard = ({
    ...
    <Card3D intensity={featured ? 0.8 : 0.5}>
      <Card
        className={`gaming-card group overflow-hidden h-full flex flex-col ${
      ...
      >
        ...
        <CardHeader>
          ...
          <CardDescription
            className={`line-clamp-2 ${featured ? "text-base" : "text-sm"}`}
          >
            {blog.excerpt}
          </CardDescription>
        </CardHeader>
      ...
      <div className="container mx-auto px-4 pt-32 pb-16">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto pb-1">
            Behind-the-scenes insights, development updates, and thoughts from
            the DSY Studio team.
          </p>
        </motion.div>
