    ...
    if (formData.attachment) {
      ...
      try {
        ...
        toast({
          ...
          description: "Could not verify the attached file. Please try again.",
          variant: "destructive",
        });
        setIsLoading(false);
      ...
      const {
        data: { publicUrl },
      } = supabase.storage.from("contact-attachments").getPublicUrl(fileName);
      ...
      <div className="container mx-auto px-4 pt-32 pb-16">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Have a question, a bug to report, or an idea to share? We'd love to
            hear from you.
          </p>
        </motion.div>
        <motion.div variants={cardVariants} initial="hidden" animate="visible">
          <Card3D intensity={0.7}>
            <Card className="gaming-card max-w-2xl mx-auto glass-card">
              <CardHeader>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="subject"
                      placeholder="e.g., Bug Report for Antim Yatra"
                      required
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="attachment" className="flex items-center">
                      ...
                      Report a Bug/Glitch (Optional)
                    </Label>
                    <div className="relative border border-dashed border-primary/30 rounded-lg p-4 text-center hover:border-primary/50 transition-colors">
                      <Paperclip className="w-6 h-6 mx-auto mb-2 text-muted-foreground" />
                      <p className="text-sm text-muted-foreground">
                        {formData.attachment
                          ? `File: ${formData.attachment.name}`
                          : "Attach a screenshot or video (Max 5MB)"}
                      </p>
                      <Input
                        id="attachment"
                        type="file"
