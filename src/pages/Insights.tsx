...
const Insights = () => {
  ...
  const categories = [
    "All",
    ...Array.from(
      new Set(insights.map((insight) => insight.category).filter(Boolean)),
    ),
  ];
  const pinnedInsights = insights.filter((insight) => insight.is_pinned);
  const popularInsights = insights.filter(
    (insight) => insight.likes > 10 && !insight.is_pinned,
  );
        ...
        <div className="container mx-auto px-4 pt-32 pb-16">
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
              No discussions available at the moment. Check back soon for
              community insights!
            </p>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-hero">
      <SEO
        ...
        description="Join discussions, share your game insights, and connect with fellow gamers and the developers at DSY Studio."
        canonical="/insights"
      />
      <GamingHeader />
      <div className="container mx-auto px-4 pt-32 pb-16">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto pb-1">
            Join discussions, share insights, and connect with fellow gamers and
            developers.
          </p>
        </motion.div>
          ...
          popularInsights.length > 0 && (
            <div className="mb-12">
              ...
              <motion.div
                ...
                animate="visible"
              >
                {popularInsights.slice(0, 3).map((insight) => (
                  <motion.div key={insight.id} variants={cardVariants}>
